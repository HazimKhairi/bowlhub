...
class TeamBereguImport extends ParticipantImport
{
    /**
    ...
    /**
     * Get the validation rules for team beregu import.
     */
    public function rules(): array
    {
        $rules = parent::rules();

        // Team beregu import requires ketua_kp, ketua_nama, and ketua_telefon
